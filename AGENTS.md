...
- **ArgoCD syncs from**: `forgejo.forgejo.svc.cluster.local:3000/christian/homelab-k8s.git` (via Tailscale egress service `forgejo.argocd.svc.cluster.local`) using app-of-apps pattern (`apps/` → `manifests/`).
