...
- **NFS backup storage**: StorageClass `nfs-backup` backed by NAS at 192.168.178.39:/volume1/k8s-backup. Used by backup CronJobs for Mealie, Vikunja, and Authentik.
